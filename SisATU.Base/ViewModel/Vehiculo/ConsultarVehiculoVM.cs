...
{
    public class ConsultarVehiculoVM
    {
        ...
        public string NRO_TARJETA_PROPIEDAD { get; set; }
        public string FECHA_INICIO_PROPIEDAD { get; set; }
        public string FECHA_FIN_PROPIEDAD { get; set; }
