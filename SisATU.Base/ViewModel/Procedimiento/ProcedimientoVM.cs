...
namespace SisATU.Base.ViewModel
{
    public class ProcedimientoVM
    {
        ...
        public int ID_PROCEDIMIENTO_PADRE { get; set; }
        public int ID_PROCEDIMIENTO_HIJO { get; set; }

        public string PROCEDIMIENTO_PROCEDENCIA { get; set; }
    }
}
