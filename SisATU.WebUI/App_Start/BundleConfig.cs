    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/plugins/bootstrap-datetimepicker").Include(
                     "~/Scripts/plugins/bootstrap-datetimepicker/moment.js",
                     "~/Scripts/plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.js",
                     "~/Scripts/plugins/bootstrap-datetimepicker/es.js"));

            // Bootstrap datetime CSS
            bundles.Add(new StyleBundle("~/plugins/datetimepickerStyles").Include(
                      "~/Content/plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.css"));
